		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Update a Class</li>
				</ul>
				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<form id="updateClassInfo" class="form-horizontal" action="classInfo!updateClassInfo.action" method="post">
								<div class="control-group">
									<label>Class</label>
									<input type="hidden" value="${classInfo.classId}" name="classInfo.classId"/>
									<select name="classInfo.gradeInfo.gradeId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allGradeInfo}" var="grade">
  										<option value ="${grade.gradeId}" ${request.classInfo.gradeInfo.gradeId eq grade.gradeId?"selected":""}>${grade.gradeName}</option>
  									</c:forEach> 
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" value="${classInfo.className}" name="classInfo.className"/>
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateClassInfo'),
				[{
					name: 'name',
					rules: 'required'
				}],{
