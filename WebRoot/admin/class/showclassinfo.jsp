		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="classInfo!classPage.action">Class</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Show Class</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allClassInfo}" var="cla" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													<td>${cla.classId}</td>
													<td>${cla.gradeInfo.gradeName}</td>
													<td>${cla.className}</td>
													<td>
													<a id="modal-585573" href="#${cla.classId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${cla.classId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Class : ${cla.className} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='classInfo!deleteClassInfo.action?classInfo.classId=${cla.classId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="classInfo!forUpdateClassInfo.action?classInfo.classId=${cla.classId}">Update</a></td>
										    	</tr>
											</c:if>
