						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="classInfo!forAddClassInfo.action" class="bottom_tooltip" title="add a new class">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="classInfo!showClassInfo.action" class="bottom_tooltip" title="remove class">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="classInfo!showClassInfo.action" class="bottom_tooltip" title="update class">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="classInfo!showClassInfo.action" class="bottom_tooltip" title="search class">
