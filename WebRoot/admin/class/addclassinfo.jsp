		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Class</li>
				</ul>
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Class</h3>
														...
														<form id="addClassInfo" class="form-horizontal" action="classInfo!addClassInfo.action" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" name="classInfo.className" placeholder="Name" />
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addClassInfo'),
				[{
					name: 'name',
					rules: 'required'
				}],{
