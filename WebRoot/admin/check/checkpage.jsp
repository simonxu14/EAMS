						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allCheckInfo}" var="check" varStatus="i">
											<c:if test="${i.count%2==0}">
												<tr class="success">
													<td>${check.checkId}</td>
													<td>${check.empInfo.empName}</td>
													<td>${check.gradeInfo.gradeName}</td>
													<td>${check.classInfo.className}<td>
												</tr>
											</c:if>
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="checkInfo!forAddCheckInfo.action" class="bottom_tooltip" title="add a new check in">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="checkInfo!showCheckInfo.action" class="bottom_tooltip" title="remove check in">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="checkInfo!showCheckInfo.action" class="bottom_tooltip" title="update check in">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="checkInfo!showCheckInfo.action" class="bottom_tooltip" title="search check in">
