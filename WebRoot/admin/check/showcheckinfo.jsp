		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Check In</li>
				</ul>
										...
										<c:forEach items="${allCheckInfo}" var="check" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													...
													<td>${check.checkYear}</td>
													<td>${check.checkMonth}</td>
													<td>
													<a href="<%=basePath %>${check.checkFile}">Download</a>
													</td>
													<td>
													<a id="modal-585573" href="#${check.checkId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${check.checkId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Check In ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='checkInfo!deleteCheckInfo.action?checkInfo.checkId=${check.checkId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="checkInfo!forUpdateCheckInfo.action?checkInfo.checkId=${check.checkId}">Update</a></td>
										    	</tr>
											</c:if>
