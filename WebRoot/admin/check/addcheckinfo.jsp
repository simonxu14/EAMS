		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Check In</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Check In</h3>
							</div>
							<form class="form-horizontal" action="checkInfo!addCheckInfo.action" method="post" enctype="multipart/form-data">
								...
								<div class="control-group">
									<label>Grade</label>
									<!-- ％％％％％％％％％％％％％％％％％％ -->
									<!-- onChange="getCla(this.value)" --> 
									<!-- ％％％％％％％％％％％％％％％％％％ -->
									<select name="checkInfo.gradeInfo.gradeId" id="thegrade" class="cselect span8" data-placeholder="Select category...">
								...
								<div class="control-group">
									<label>Class</label>
									<select name="checkInfo.classInfo.classId" id="theclass" class="cselect span8" data-placeholder="Select category...">
