		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Position</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allPostInfo}" var="post" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													<td>${post.postId}</td>
													<td>${post.depInfo.orgInfo.orgName} & ${post.depInfo.depName}</td>
													<td>${post.postName}</td>
													<td>${post.postSalary}</td>
													<td>
													<a id="modal-585573" href="#${post.postId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${post.postId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Position :${post.depInfo.orgInfo.orgName} & ${post.depInfo.depName} : ${post.postName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='postInfo!deletePostInfo.action?postInfo.postId=${post.postId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="postInfo!forUpdatePostInfo.action?postInfo.postId=${post.postId}">Update</a></td>
										    	</tr>
											</c:if>
