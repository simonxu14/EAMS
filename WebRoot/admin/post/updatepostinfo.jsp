		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="postInfo!postPage.action">Position</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Position</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update Position</h3>
							</div>
							<form id="updatePostInfo" class="form-horizontal" action="postInfo!updatePostInfo.action" method="post">
								<div class="control-group">
									<label>Organization & Department</label>
									<input type="hidden" value="${postInfo.postId}" name="postInfo.postId"/>
									<select name="postInfo.depInfo.depId" class="cselect span8">
									<c:forEach items="${allDepInfo}" var="dep">
  										<option value ="${dep.depId}" ${request.postInfo.depInfo.depId eq dep.depId?"selected":""}>${dep.orgInfo.orgName} & ${dep.depName}</option>
  									</c:forEach> 
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" value="${postInfo.postName}" name="postInfo.postName"/>
									</div>
									</div>
							<div class="control-group">
								<label class="control-label">Salary</label>
								<div class="controls">
									<input id="salary" type="text" value="${postInfo.postSalary}" name="postInfo.postSalary"
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updatePostInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
				...
				function check(){
					...
					if(updatePostInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					if(updatePostInfo.salary.value == ""){
						alert("please check the inputs");
						return;
					}
