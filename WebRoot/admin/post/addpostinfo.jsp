		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Department</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Department</h3>
							</div>
							<form id="addPostInfo" class="form-horizontal" action="postInfo!addPostInfo.action" method="post" >
								<div class="control-group">
									<label>Organization & Department</label>
									<select name="postInfo.depInfo.depId" class="cselect span8" data-placeholder="Select category...">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" name="postInfo.postName"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="salary" type="text" name="postInfo.postSalary"
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addPostInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
				...
				function check(){
					...
					if(addPostInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					if(addPostInfo.salary.value == ""){
						alert("please check the inputs");
						return;
					}
					else{
