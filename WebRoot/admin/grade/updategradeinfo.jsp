		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Update a Grade</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update Grade</h3>
							</div>
							<form id="updateGradeInfo" class="form-horizontal" action="gradeInfo!updateGradeInfo.action" method="post">
                                <input type="hidden" value="${gradeInfo.gradeId}" name="gradeInfo.gradeId"/>
								<div class="control-group">
									<label class="control-label" for="inputEmail">Name</label>
									<div class="controls">
										<input id="name" type="text" value="${gradeInfo.gradeName}" name="gradeInfo.gradeName" />
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateGradeInfo'),
				[{
					name: 'name',
					rules: 'required'
				}],{
				...
				function check(){
					...
					if(updateGradeInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					
					else{
						updateGradeInfo.submit();
					}
				}
			</script>
			<!-- end main content -->
