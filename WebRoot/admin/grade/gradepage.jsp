						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allGradeInfo}" var="grade" varStatus="i">
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="<%=basePath%>admin/grade/addgradeinfo.jsp" class="bottom_tooltip" title="add a new grade">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="gradeInfo!showGradeInfo.action" class="bottom_tooltip" title="remove grade">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="gradeInfo!showGradeInfo.action" class="bottom_tooltip" title="update grade">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="gradeInfo!showGradeInfo.action" class="bottom_tooltip" title="search grade">
