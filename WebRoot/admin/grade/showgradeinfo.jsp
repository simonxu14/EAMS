		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Grade</li>
				</ul>
										...
										<c:forEach items="${allGradeInfo}" var="grade" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													...
													<td>
													<a id="modal-585573" href="#${grade.gradeId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${grade.gradeId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Grade : ${grade.gradeName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='gradeInfo!deleteGradeInfo.action?gradeInfo.gradeId=${grade.gradeId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="gradeInfo!forUpdateGradeInfo.action?gradeInfo.gradeId=${grade.gradeId}">Update</a></td>
										    	</tr>
											</c:if>
