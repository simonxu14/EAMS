		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="powerInfo!powerPage.action">Power</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Power</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update Power</h3>
							</div>
							<form id="updatePowerInfo" class="form-horizontal" action="powerInfo!updatePowerInfo.action" method="post">
                                <input type="hidden" value="${powerInfo.powerId}" name="powerInfo.powerId"/>
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input id="name" type="text" value="${powerInfo.powerName}" name="powerInfo.powerName" />
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="inputEmail">Power</label>
									<div class="controls">
									System Manager<input id="check6" type="checkbox" value="100000" name="powerInfo.powerAccountArray"/><br/>
   				  					Keyboarder<input id="check5" type="checkbox" value="10000" name="powerInfo.powerAccountArray"/><br/>
   				   					Charge Operator<input id="check4" type="checkbox" value="1000" name="powerInfo.powerAccountArray"/><br/>
   				   					Teacher Manager<input id="check3" type="checkbox" value="100" name="powerInfo.powerAccountArray"/><br/>
	               					Finance Manager<input id="check2" type="checkbox" value="10" name="powerInfo.powerAccountArray"/><br/>
   				   					Education Manager<input id="check1" type="checkbox" value="1" name="powerInfo.powerAccountArray"/><br/>
   				   					</div>
   				   				</div>
								<div class="control-group">
									<label class="control-label">Order</label>
									<div class="controls">
										<input type="text" value="${powerInfo.powerComment}" name="powerInfo.powerComment"/>
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updatePowerInfo'),
				[{
					name: 'name',
					rules: 'required'
				}],{
