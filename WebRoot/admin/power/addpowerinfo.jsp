		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Power</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Power</h3>
							</div>
							
							
														<form id="addPowerInfo" class="form-horizontal" action="powerInfo!addPowerInfo.action" method="post">

								
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input id="name" type="text" name="powerInfo.powerName" placeholder="Name" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										System Manager<input id="power" type="checkbox" value="100000" name="powerInfo.powerAccountArray" /><br/>
										Keyboarder<input id="power" type="checkbox" value="10000" name="powerInfo.powerAccountArray"/><br/>
										Charge Operator<input id="power" type="checkbox" value="1000" name="powerInfo.powerAccountArray"/><br/>
										Teacher Manager<input id="power" type="checkbox" value="100" name="powerInfo.powerAccountArray"/><br/>
										Finance Manager<input id="power" type="checkbox" value="10" name="powerInfo.powerAccountArray"/><br/>
										Education Manager<input id="power" type="checkbox" value="1" name="powerInfo.powerAccountArray"/><br/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Comment</label>
									<div class="controls">
										<input type="text" name="powerInfo.powerComment" placeholder="Comment" />
									</div>
								</div>
								<div class="control-group">
									<div class="controls">
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addPowerInfo'),
				[{
					name: 'name',
					rules: 'required'
				}],{
