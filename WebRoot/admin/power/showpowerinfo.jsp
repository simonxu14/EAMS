		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Power</li>
				</ul>
										...
										<c:forEach items="${allPowerInfo}" var="power" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													...
													<td>
													<a id="modal-585573" href="#${power.powerId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${power.powerId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Organization : ${power.powerName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='powerInfo!deletePowerInfo.action?powerInfo.powerId=${power.powerId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="powerInfo!forUpdatePowerInfo.action?powerInfo.powerId=${power.powerId}">Update</a></td>
										    	</tr>
											</c:if>
