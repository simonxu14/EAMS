						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allPowerInfo}" var="power" varStatus="i">
											<c:if test="${i.count%2==0}">
												<tr class="success">
													...
													<td>
														...
														var string="";
														var a=${power.powerAccount};
														if(a%2 == 1)
														string = string + "Education Manager<br/>";
														a = a/10;
														a = a.toFixed(0);
														if(a%2 == 1)
														string = string + "Finance Manager<br/>";
														a = a/10;
														a = a.toFixed(0);
														if(a%2 == 1)
														string = string + "Teacher Manager<br/>";
														a = a/10;
														a = a.toFixed(0);
														if(a%2 == 1)
														string = string + "Charge Operator<br/>";
														a = a/10;
														a = a.toFixed(0);
														if(a%2 == 1)
														string = string + "Keyboarder<br/>";
														a = a/10;
														a = a.toFixed(0);
														if(a%2 == 1)
														string = string + "System Manager<br/>";
														a = a/10;
														a = a.toFixed(0);
														document.write(string);
													</script>
													</td>
													<td>${power.powerComment}</td>
												</tr>
											</c:if>
						...
						<div class="well widget">
							...
							<div class="media media-feed">
								<div class="media-body">
									<a href="#"><h4 class="media-heading">Monster University in American</h4></a>
									<p class="meta">
										<span class="tags"><a href="#" class="text-warning">14</a></span>
									</p>
									<p class="excerpt">Monster University in American</p>
								</div>
							</div>
							<!-- ./ media object -->
							...
							<div class="media media-feed">
								<div class="media-body">
									<a href="#"><h4 class="media-heading">Monster University in China</h4></a>
									<p class="meta">
										<span class="tags"><a href="#" class="text-warning">16</a></span>
									</p>
									<p class="excerpt">Monster University in China</p>
								</div>
							</div>
							<!-- ./ media object -->
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="<%=basePath%>admin/power/addpowerinfo.jsp" class="bottom_tooltip" title="add a new power">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="powerInfo!showPowerInfo.action" class="bottom_tooltip" title="remove power">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="powerInfo!showPowerInfo.action" class="bottom_tooltip" title="update power">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="powerInfo!showPowerInfo.action" class="bottom_tooltip" title="search power">
