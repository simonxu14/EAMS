		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Schedule</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="media media-feed">
								<div class="media-body">
									<a href="#"><h4 class="media-heading">Teacher Management Department</h4></a>
									<p class="meta">
										<span class="tags"><a href="#" class="text-warning">14</a></span>
									</p>
									<p class="excerpt">Teacher Management Department</p>
								</div>
							</div>
							<!-- ./ media object -->
							...
							<div class="media media-feed">
								<div class="media-body">
									<a href="#">
									<h4 class="media-heading">Student Management Department</h4>
									</a>
									<p class="meta">
										<span class="tags"><a href="#" class="text-warning">16</a></span>
									</p>
									<p class="excerpt">Student Management Department</p>
								</div>
							</div>
							<!-- ./ media object -->
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="scheduleInfo!forAddScheduleInfo.action" class="bottom_tooltip" title="add a new schedule">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="scheduleInfo!showScheduleInfo.action" class="bottom_tooltip" title="remove schedule">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="scheduleInfo!showScheduleInfo.action" class="bottom_tooltip" title="update schedule">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="scheduleInfo!showScheduleInfo.action" class="bottom_tooltip" title="search schedule">
