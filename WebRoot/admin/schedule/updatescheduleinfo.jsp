		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="scheduleInfo!schedulePage.action">Schedule</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Schedule</li>
				</ul>
				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<form class="form-horizontal" action="scheduleInfo!updateScheduleInfo.action" method="post">
								<div class="control-group">
									<label>Employee</label>
									<input type="hidden" value="${scheduleInfo.schId}" name="scheduleInfo.schId"/>
									<select name="scheduleInfo.empInfo.empId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allEmpInfo}" var="emp">
  										<option value ="${emp.empId}" ${request.scheduleInfo.empInfo.empId eq emp.empId?"selected":""}>${emp.empName}</option>
  									</c:forEach> 
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value='<s:date name="scheduleInfo.schStart" format="MM-dd-yyyy"/>' name="scheduleInfo.schStart" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value='<s:date name="scheduleInfo.schEnd" format="MM-dd-yyyy"/>' name="scheduleInfo.schEnd" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea id="redactor_content" class="fullRedactor" name="scheduleInfo.schContent">
										<c:out value="${scheduleInfo.schContent}"></c:out>
										</textarea>
									</div>
								</div>
