		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="scheduleInfo!schPage.action">Schedule</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Show Schedule</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allScheduleInfo}" var="schedule" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													<td>${schedule.schId}</td>
													<td>${schedule.empInfo.empName}</td>
													<td>
													<fmt:formatDate value="${schedule.schStart}" pattern="MM-dd-yyyy"/>
													</td>
													<td>
													<fmt:formatDate value="${schedule.schEnd}" pattern="MM-dd-yyyy"/>
													</td>
													<td>
													<a id="modal-585573" href="#${schedule.schId}1" role="button"  data-toggle="modal">See</a>
													<div id="${schedule.schId}1" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													...
													<td>
													<a id="modal-585573" href="#${schedule.schId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${schedule.schId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
					 										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
																<h3 id="myModalLabel">
																Delete a Schedule?
														...
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='scheduleInfo!deleteScheduleInfo.action?scheduleInfo.schId=${schedule.schId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="scheduleInfo!forUpdateScheduleInfo.action?scheduleInfo.schId=${schedule.schId}">Update</a></td>
										    	</tr>
										    </c:if>
										    <c:if test="${i.count%4==1}">
												<tr class="success">
													...
													<td><a id="modal-585573" href="#${schedule.schId}1" role="button"  data-toggle="modal">See</a>
													<div id="${schedule.schId}1" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
					 										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
																<h3 id="myModalLabel">
