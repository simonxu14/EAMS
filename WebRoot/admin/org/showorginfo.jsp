		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Organization</li>
				</ul>
										...
										<c:forEach items="${allOrgInfo}" var="org" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													...
													<td>${org.orgOrder}</td>
													<td>
													<a id="modal-585573" href="#${org.orgId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${org.orgId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Organization : ${org.orgName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='orgInfo!deleteOrgInfo.action?orgInfo.orgId=${org.orgId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="orgInfo!forUpdateOrgInfo.action?orgInfo.orgId=${org.orgId}">Update</a></td>
										    	</tr>
											</c:if>
