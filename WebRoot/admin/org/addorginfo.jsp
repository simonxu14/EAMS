		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Organization</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Organization</h3>
							</div>
							
							
							<form class="form-horizontal" id="addOrgInfo" action="orgInfo!addOrgInfo.action" method="post">

								
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input type="text" id="name" name="orgInfo.orgName" placeholder="Name"
										/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="order" name="orgInfo.orgOrder" placeholder="Order" 
								...
								<div class="control-group">
									<div class="controls">
									<button class="btn btn-warning" type="button" onclick="check()">Submit</button>
									</div>
								</div>
							</form>
