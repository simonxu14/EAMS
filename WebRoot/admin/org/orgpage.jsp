		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Organization</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allOrgInfo}" var="org" varStatus="i">
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="<%=basePath%>admin/org/addorginfo.jsp" class="bottom_tooltip" title="add a new organization">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="orgInfo!showOrgInfo.action" class="bottom_tooltip" title="remove organization">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="orgInfo!showOrgInfo.action" class="bottom_tooltip" title="update organization">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="orgInfo!showOrgInfo.action" class="bottom_tooltip" title="search organization">
