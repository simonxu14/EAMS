		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="orgInfo!orgPage.action">Organization</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Organization</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update Organization</h3>
							</div>
							<form id="addorginfo" class="form-horizontal" name="" action="orgInfo!updateOrgInfo.action" method="post">
                                <input type="hidden" value="${orgInfo.orgId}" name="orgInfo.orgId"/>
								<div class="control-group">
									<label class="control-label" for="inputEmail">Name</label>
									<div class="controls">
										<input type="text" id="name" value="${orgInfo.orgName}" name="orgInfo.orgName" />
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label" for="inputEmail">Order</label>
									<div class="controls">
										<input type="text" id="order" value="${orgInfo.orgOrder}" name="orgInfo.orgOrder"
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addorginfo'),
				[{
					name: 'name',
					rules: 'required'
				},
				...
				function check(){
					if(addorginfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					if(addorginfo.order.value == ""){
						alert("please check the inputs");
						return;
					}
					else{
