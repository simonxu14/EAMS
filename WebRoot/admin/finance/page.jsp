			...
			<div id="main_content" class="container-fluid">
				...
				<div class="row-fluid">
						...
						<div class="well widget">
						    ...
						    <dl class="dl-icon">
							    ...
							    <dd>
								    ...
								    <p>${empInfo_session.orgInfo.orgName}</p>
							    ...
							    <dd>
								    ...
								    <p>${empInfo_session.depInfo.depName}</p>
							    </dd>
							    <dt>Position</dt>
							    <dd>
								    <span class="icon-wrapper">
								    ...
								    <p>${empInfo_session.postInfo.postName}</p>
							    </dd>
							    <dt>Name</dt>
							    <dd>
								    <span class="icon-wrapper">
							    ...
							    <dd>
								    ...
								    <p>
								    <fmt:formatDate value="${empInfo_session.empBirth}" pattern="MM-dd-yyyy"/>
								    </p>
							    </dd>
							    <dt>Phone</dt>
							    <dd>
							    ...
							    <dd>
								    ...
								    <p>${empInfo_session.empAddress}</p>
							    </dd>
								
						    </dl>
							<center>
						    <a class="btn btn-flat btn-warning btn-mini" href="empInfo!myForUpdateEmpInfo.action?empInfo.empId=${empInfo_session.empId}">Update</a>
							</center>
						</div>
					...
					<div class="span8">
						...
						<form method="post" action="scheduleInfo!myAddScheduleInfo.action" >
							<!-- widget -->
							<div class="well widget kuta-editor">
								...
								<!-- ./ widget header -->
								<input type="hidden" name="scheduleInfo.empInfo.empId" value="${empInfo_session.empId}">
								<!-- widget content -->
								<textarea id="redactor_content" class="fullRedactor" name="scheduleInfo.schContent"></textarea>
								<!-- ./ widget content -->
							...
							<div class="action-wrapper">
								<div class="pull-left">
									<input type="text" value="03-21-2014" class="datePicker" name="scheduleInfo.schStart" id="datepicker1" placeholder="publish date" />
									<span class="help-inline">Schedule start date</span>
									<input type="text" value="03-21-2014" class="datePicker" name="scheduleInfo.schEnd" id="datepicker1" placeholder="publish date" />
									<span class="help-inline">Schedule end date</span>
								</div>
								<div class="pull-right">
									<button class="btn btn-flat btn-primary" type="submit">publish</button>
								</div>
							</div>
