		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Employee</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allEmpInfo}" var="emp" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													<td>${emp.empId}</td>
													<td>${emp.empName}</td>
 													<td>${emp.orgInfo.orgName}</td>
 													<td>${emp.depInfo.depName}</td>
 													<td>${emp.postInfo.postName}</td>
													...
													<a id="modal-585573" href="#${emp.empAccount}" role="button"  data-toggle="modal">Detail</a>
													
													<div id="${emp.empAccount}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<table class="table table-hover">
															...
															<tbody>
																...
																<tr>
																	<td>8</td>
																	<td>Power</td>
																	<td>${emp.powerInfo.powerName}</td>
																</tr>
																<tr>
																	<td>9</td>
																	<td>Photo</td>
																	<td><img class="thumb account-img" src="<%=basePath%>${emp.empPhoto}"/></td>
																</tr>
																<tr>
																	<td>10</td>
																	<td>Sex</td>
																...
																<tr>
																	...
																	<td>Birth</td>
																	<td>
																	<fmt:formatDate value="${emp.empBirth}" pattern="MM-dd-yyyy"/>
																	</td>
																</tr>
																<tr>
																	<td>12</td>
													...
													<td>
													<a id="modal-585573" href="#${emp.empId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${emp.empId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
					 										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
																<h3 id="myModalLabel">
																Delete a Employee?
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Employee : ${emp.empName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='empInfo!deleteEmpInfo.action?empInfo.empId=${emp.empId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="empInfo!forUpdateEmpInfo.action?empInfo.empId=${emp.empId}">Update</a></td>
										    	</tr>
											</c:if>
