		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add a Employee</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new Employee</h3>
							</div>
							<form id="addEmpInfo" class="form-horizontal" action="empInfo!addEmpInfo.action" method="post" enctype="multipart/form-data">
								...
								<div class="control-group">
									...
									<select name="empInfo.depInfo.depId" class="cselect span8" data-placeholder="Select category...">
   									<c:forEach items="${allDepInfo}" var="dep">
  										<option value ="${dep.depId}">${dep.orgInfo.orgName} & ${dep.depName}</option>
  									</c:forEach> 
									</select>
									<p></p>
									<hr />
								...
								<div class="control-group">
									...
									<select name="empInfo.postInfo.postId" class="cselect span8" data-placeholder="Select category...">
   									<c:forEach items="${allPostInfo}" var="post">
  										<option value ="${post.postId}">${post.depInfo.orgInfo.orgName} & ${post.depInfo.depName} & ${post.postName}</option>
  									</c:forEach> 
									</select>
									<p></p>
									<hr />
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="account" type="text" name="empInfo.empAccount" placeholder="Account" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input id="name" type="text" name="empInfo.empName" placeholder="Name" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Password</label>
									<div class="controls">
										<input id="password1" type="password" name="empInfo.empPassword" placeholder="Password" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										Male   <input id="sex" type="checkbox" value="true" name="empInfo.empSex"/></br>
										Female <input id="sex" type="checkbox" value="false" name="empInfo.empSex"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="03-13-2014" name="empInfo.empBirth" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="idcard" type="text" name="empInfo.empIdcard" placeholder="ID card" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="phone" type="text" name="empInfo.empPhone" placeholder="Phone" 
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="qq" type="text" name="empInfo.empQq" placeholder="QQ" 
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="empInfo.empAddress" placeholder="Address" />
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addEmpInfo'),
				[{
					name: 'account',
					rules: 'required'
				},
				...
				function check(){
					...
					if(addEmpInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					
					if(addEmpInfo.password1.value == ""){
						alert("please check the inputs");
						return;
					}
					if(addEmpInfo.password2.value == ""){
						alert("please check the inputs");
						return;
					}
					if(addEmpInfo.phone.value == ""){
						alert("please check the inputs");
						return;
					}
