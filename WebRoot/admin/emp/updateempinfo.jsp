		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="empInfo!empPage.action">Employee</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Employee</li>
				</ul>
				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<form id="updateEmpInfo" class="form-horizontal" action="empInfo!updateEmpInfo.action" method="post" enctype="multipart/form-data">
								<div class="control-group">
									<label>Organization</label>
									<input type="hidden" value="${empInfo.empId}" name="empInfo.empId"/>
									<select name="empInfo.orgInfo.orgId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allOrgInfo}" var="org">
  										<option value ="${org.orgId}" ${request.empInfo.orgInfo.orgId eq org.orgId?"selected":""}>${org.orgName}</option>
  									</c:forEach>
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									...
									<select name="empInfo.depInfo.depId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allDepInfo}" var="dep">
  										<option value ="${dep.depId}" ${request.empInfo.depInfo.depId eq dep.depId?"selected":""}>${dep.orgInfo.orgName} & ${dep.depName}</option>
  									</c:forEach>
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									...
									<select name="empInfo.postInfo.postId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allPostInfo}" var="post">
  										<option value ="${post.postId}" ${request.empInfo.postInfo.postId eq post.postId?"selected":""}>${post.depInfo.orgInfo.orgName} & ${post.depInfo.depName} & ${post.postName}</option>
  									</c:forEach>
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									<label>Power</label>
									<select name="empInfo.powerInfo.powerId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allPowerInfo}" var="power">
  										<option value ="${power.powerId}" ${request.empInfo.powerInfo.powerId eq power.powerId?"selected":""}>${power.powerName}</option>
  									</c:forEach>
									</select>
									<p></p>
									<hr/>
								...
								<div class="control-group">
									<img class="thumb account-img" src="<%=basePath%>${empInfo.empPhoto}"/>
								</div>
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input id="name" type="text" value="${empInfo.empName}" name="empInfo.empName"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Account</label>
									<div class="controls">
										<input id="account" type="text" value="${empInfo.empAccount}" name="empInfo.empAccount"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Password</label>
									<div class="controls">
										<input id="password" readonly="readonly" type="password" value="${empInfo.empPassword}" name="empInfo.empPassword"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Photo</label>
									<div class="controls">
										<input type="file" name="upload" value="<%=basePath%>${empInfo.empPhoto}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										Male<input id="man" type="checkbox" value="true" name="empInfo.empSex"/>
   	                          			Female<input id="woman" type="checkbox" value="false" name="empInfo.empSex"/></br>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value='<s:date name="empInfo.empBirth" format="MM-dd-yyyy"/>' name="empInfo.empBirth" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="idcard" type="text" value="${empInfo.empIdcard}" name="empInfo.empIdcard"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="phone" type="text" value="${empInfo.empPhone}" name="empInfo.empPhone"
										
										onafterpaste="this.value=this.value.replace(/\D/g,'')"
										onkeyup="this.value=this.value.replace(/\D/g,'')"
										onkeypress="if(window.evernt.keyCode<48 || windows.event.keyCode>57) window.event.keyCode = 0;"	
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="qq" type="text" value="${empInfo.empQq}" name="empInfo.empQq"
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empAddress}" name="empInfo.empAddress"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empStart}" name="empInfo.empStart" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empEnd}" name="empInfo.empEnd" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateEmpInfo'),
				[{
					name: 'account',
					rules: 'required'
				},
				...
				function check(){
					...
					if(updateEmpInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					
					if(updateEmpInfo.phone.value == ""){
						alert("please check the inputs");
						return;
					}
