		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Employee</li>
				</ul>
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="empInfo!forAddEmpInfo.action" class="bottom_tooltip" title="add a new employee">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="empInfo!showEmpInfo.action" class="bottom_tooltip" title="remove employee">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="empInfo!showEmpInfo.action" class="bottom_tooltip" title="update employee">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="empInfo!showEmpInfo.action" class="bottom_tooltip" title="search employee">
