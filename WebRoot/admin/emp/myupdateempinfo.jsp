				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<form class="form-horizontal" action="empInfo!myUpdateEmpInfo.action" method="post" enctype="multipart/form-data">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empName}" name="empInfo.empName"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Account</label>
									<div class="controls">
										<input type="text" value="${empInfo.empAccount}" name="empInfo.empAccount"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Password</label>
									<div class="controls">
										<input readonly="readonly" type="password" value="${empInfo.empPassword}" name="empInfo.empPassword"/>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empIdcard}" name="empInfo.empIdcard"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empPhone}" name="empInfo.empPhone"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="${empInfo.empQq}" name="empInfo.empQq"/>
									</div>
								</div>
