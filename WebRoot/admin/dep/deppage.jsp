		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Department</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
										<c:forEach items="${allDepInfo}" var="dep" varStatus="i">
											<c:if test="${i.count%2==0}">
												<tr class="success">
													<td>${dep.depId}</td>
													<td>${dep.orgInfo.orgName}</td>
													<td>${dep.depName}</td>
													<td>${dep.depOrder}<td>
												</tr>
											</c:if>
						...
						<div class="well bg-d widget">
							...
							<div class="widget-content">
								<div class="btn-circle-panel large">
									<ul class="btn-circle">
										<li class="danger">
											<a href="depInfo!forAddDepInfo.action" class="bottom_tooltip" title="add a new department">
												<i class="icon-book text-error"></i>
											</a>
										</li>
										<li class="info">
											<a href="depInfo!showDepInfo.action" class="bottom_tooltip" title="remove department">
												<i class="icon-remove text-info"></i>
											</a>
										</li>
										<li class="success">
											<a href="depInfo!showDepInfo.action" class="bottom_tooltip" title="update department">
												<i class="icon-pencil text-success"></i>
											</a>
										</li>
										<li class="warning">
											<a href="depInfo!showDepInfo.action" class="bottom_tooltip" title="search department">
