		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show Department</li>
				</ul>
										...
										<c:forEach items="${allDepInfo}" var="dep" varStatus="i">
											<c:if test="${i.count%4==0}">
												<tr class="success">
													...
													<td>${dep.depOrder}</td>
													<td>
													<a id="modal-585573" href="#${dep.depId}" role="button"  data-toggle="modal">Delete</a>
													
													<div id="${dep.depId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<p>
															Do you want to Delete the Department : ${dep.depName} ?
															</p>
														</div>
														<div class="modal-footer">
					 										<button class="btn" data-dismiss="modal" aria-hidden="true">No, I don't</button>
					 										<button  onclick="javascript:window.location.href='depInfo!deleteDepInfo.action?depInfo.depId=${dep.depId}'" class="btn btn-primary">
					 										Yes, I wanna
					 										</button>
														</div>
													</div>
													</td>
													<td><a href="depInfo!forUpdateDepInfo.action?depInfo.depId=${dep.depId}">Update</a></td>
										    	</tr>
											</c:if>
