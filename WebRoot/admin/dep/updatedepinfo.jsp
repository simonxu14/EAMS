		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="depInfo!depPage.action">Department</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Update a Department</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update Department</h3>
							</div>
<form id="updateDepInfo" class="form-horizontal" action="depInfo!updateDepInfo.action" method="post">
								<div class="control-group">
									<label>Organization</label>
									<input type="hidden" value="${depInfo.depId}" name="depInfo.depId"/>
									
									
									
									<select name="depInfo.orgInfo.orgId" class="cselect span8" data-placeholder="Select category...">
									<c:forEach items="${allOrgInfo}" var="org">
  										<option value ="${org.orgId}" ${request.depInfo.orgInfo.orgId eq org.orgId?"selected":""}>${org.orgName}</option>
  									</c:forEach> 
									</select>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" value="${depInfo.depName}" name="depInfo.depName"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="order" type="text" value="${depInfo.depOrder}" name="depInfo.depOrder"
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateDepInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
				...
				function check(){
					...
					if(updateDepInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					if(updateDepInfo.order.value == ""){
						alert("please check the inputs");
						return;
					}
