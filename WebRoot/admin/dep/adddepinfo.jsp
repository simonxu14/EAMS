...
<!-- header -->
		...
		<div id="left_layout">
				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<form id="addDepInfo" class="form-horizontal" action="depInfo!addDepInfo.action" method="post">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="name" type="text" name="depInfo.depName" placeholder="Name" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Order</label>
									<div class="controls">
										<input id="order" type="text" name="depInfo.depOrder" placeholder="Order" 
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addDepInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
				...
				function check(){
					...
					if(addDepInfo.name.value == ""){
						alert("please check the inputs");
						return;
					}
					if(addDepInfo.order.value == ""){
						alert("please check the inputs");
						return;
					}
					else{
