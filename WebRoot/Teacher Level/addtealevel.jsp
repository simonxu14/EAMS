...
<html lang="en">
	...
	<!-- header -->
		...
		<div id="left_layout">
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Add a new teacher level</h3>
							</div>
							
							<form id="addTeacherLevel" action="teacherLevel!addLevel.action" method="post">	
								<div class="control-group">
									<label class="control-label" for="inputPassword">Name</label>
									<div class="controls">
										<input type="text" id="name" name="teacherLevel.teachLevelName" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="classfee" name="teacherLevel.teachLevelClasshour" />¥
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="basepay" name="teacherLevel.teachLevelCost" />¥
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addTeacherLevel'),
				[{
					name: 'name',
					rules: 'required'
				},
