		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="#">Teacher Level</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Show Teacher Level</li>
				</ul>
					...
					<div class="span12">
						...
						<div class="well widget">
							...
							<div class="widget-header">
								<h3 class="title">Teacher Level</h3>
							</div>
							<!-- ./ widget header -->
							...
							<div class="widget-content">
								<table class="table">
									...
									<c:forEach items="${level}" var="l">
										<tr class="success">
											<td>${l.teachLevelId}</td>
											<td>${l.teachLevelName}</td>
											<td>${l.teachLevelClasshour}</td>
											<td>${l.teachLevelCost}</td>	
											<td><a href="teacherLevel!hiddenDeleteLevel.action?teacherLevel.teachLevelId=${l.teachLevelId}">Delete</a></td>
											<td><a href="teacherLevel!updateLevel1.action?teacherLevel.teachLevelId=${l.teachLevelId}">Update</a></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
