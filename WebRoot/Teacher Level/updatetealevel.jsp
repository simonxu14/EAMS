		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="#">Teacher Level</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li><a href="#">Teacher Level</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Add a new teacher level</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Update a teacher level</h3>
							</div>
							
								
															<form id="updateTeacherLevel" action="teacherLevel!updateLevel2.action" method="post">
								<input type="hidden" name="teacherLevel.teachLevelId" value="${teacherLevel.teachLevelId}"/>
								
								<div class="control-group">
									<label class="control-label" for="inputPassword">Name</label>
									<div class="controls">
										<input type="text" id="name" name="teacherLevel.teachLevelName" value="${teacherLevel.teachLevelName}"  />
									</div>
								</div>
								
                                
								<div class="control-group">
									<label class="control-label" for="inputPassword">Class fee</label>
									<div class="controls">
										<input type="text" id="classfee" name="teacherLevel.teachLevelClasshour" value="${teacherLevel.teachLevelClasshour }"  />¥
									</div>
								</div>
                                
                                <div class="control-group">
									<label class="control-label" for="inputPassword">Base pay</label>
									<div class="controls">
										<input type="text" id="basepay" name="teacherLevel.teachLevelCost" value="${teacherLevel.teachLevelCost}"/>¥
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateTeacherLevel'),
				[{
					name: 'name',
					rules: 'required'
				},
