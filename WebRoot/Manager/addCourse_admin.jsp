		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add course</li>
				</ul>
				...
				<div class="row-fluid">
					<div class="span8">
						...
						<form id="addCourseInfo" class="form-horizontal" action="course!addCourse.action" method="post">
								<div class="control-group">
									<label class="control-label" for="inputPassword">Name</label>
									<div class="controls">
										<input id="name" type="text" name="course.courseName"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputPassword">Teacher</label>&nbsp;&nbsp;&nbsp;
									<select class="chzn-select-deselect span8"  name="course.teachInfo.teachId">
											<c:forEach items="${allTC}" var="a">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="course.courseMajor"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="remain" type="text" placeholder="Remain" name="course.courseRemain"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
									    <input type="text" value="03-13-2014" name="course.courseStart" class="datePicker" id="datepicker1" placeholder="Course Start Time" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" placeholder="Comment" name="course.courseComment"/>
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('addCourseInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
