		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
              ...
              <ul class="breadcrumb breadcrumb-main">
                ...
                <li class="text-info">Check all courses </li>
              </ul>
			  <div class="row-fluid">
                <div class="span12">
                  <div class="well widget">
                    ...
                    <div class="widget-header">
                      <h3 class="title">Check all courses</h3>
					  </div>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                        	<c:forEach items="${allCL}" var="a" varStatus="i">
							
								<c:if test="${i.count%4==1}">
									<tr class="success">
										<td>${a.courseId}</td>
										<td>${a.courseName}</td>
										<td>${a.teachInfo.teachName}</td>
										<td>${a.courseMajor}</td>
										<td>${a.courseRemain}</td>
										<td>${a.courseStart}</td>
										<td>${a.courseEnd}</td>
										<td>${a.courseComment}</td>
										<td><i class="icon-file"></i><a id="modal-981935" href="#${a.courseId}detail" role="button" data-toggle="modal">Detail</a>
													<div id="${a.courseId}detail" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<table class="table">
																...
																<tr class="success"><td>ID</td>                 <td>${a.courseId}</td></tr>
																<tr class="error"><td>Name</td>       		    <td>${a.courseName}</td></tr>
																<tr class="info"><td>Teacher</td>               <td>${a.teachInfo.teachName}</td></tr>
																<tr class="warning"><td>Major</td>  			<td>${a.courseMajor}</td></tr>
																<tr class="success"><td>Remain</td>    			<td>${a.courseRemain}</td></tr>
																<tr class="error"><td>Start</td> 				<td>${a.courseStart}</td></tr>
																<tr class="info"><td>End</td>					<td>${a.courseEnd}</td></tr>
																<tr class="warning"><td>Comment</td>			<td>${a.courseComment}</td></tr>
															</table>
													</div>
										...
										<td><i class="micon-remove"></i><a id="modal-981935" href="#${a.courseId}delete" role="button" data-toggle="modal">Delete</a>
			
													<div id="${a.courseId}delete" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														<div class="modal-header">
														...
														<div class="modal-body">
															<p>
															   Are You Sure Wanna Delete ${a.courseName}
															</p>
														</div>
														<div class="modal-footer">
															 <button class="btn btn-flat" data-dismiss="modal" aria-hidden="true">Cancel</button> 
															 <a class="btn btn-flat btn-success" href="course!deleteCourse.action?course.courseId=${a.courseId}" role="button" class="btn">Yes, I'm Sure</a>
														</div>
													</div>
													</td>
													<td>
														<i class="icon-retweet"></i><a href="course!queryCourseById.action?course.courseId=${a.courseId}">Update</a>
													</td>
								</c:if>
													...
													<div id="${a.courseId}detail" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<table class="table">
																...
																<tr class="error"><td>ID</td>                 <td>${a.courseId}</td></tr>
																<tr class="info"><td>Name</td>       		    <td>${a.courseName}</td></tr>
																<tr class="warning"><td>Teacher</td>               <td>${a.teachInfo.teachName}</td></tr>
																<tr class="success"><td>Major</td>  			<td>${a.courseMajor}</td></tr>
																<tr class="error"><td>Remain</td>    			<td>${a.courseRemain}</td></tr>
																<tr class="info"><td>Start</td> 				<td>${a.courseStart}</td></tr>
																<tr class="warning"><td>End</td>					<td>${a.courseEnd}</td></tr>
																<tr class="success"><td>Comment</td>			<td>${a.courseComment}</td></tr>
															</table>
													</div>
													<div class="modal-footer">
														 <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
													...
													<div id="${a.courseId}detail" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<table class="table">
																...
																<tr class="info"><td>ID</td>                 <td>${a.courseId}</td></tr>
																<tr class="warning"><td>Name</td>       		    <td>${a.courseName}</td></tr>
																<tr class="success"><td>Teacher</td>               <td>${a.teachInfo.teachName}</td></tr>
																<tr class="error"><td>Major</td>  			<td>${a.courseMajor}</td></tr>
																<tr class="info"><td>Remain</td>    			<td>${a.courseRemain}</td></tr>
																<tr class="warning"><td>Start</td> 				<td>${a.courseStart}</td></tr>
																<tr class="success"><td>End</td>					<td>${a.courseEnd}</td></tr>
																<tr class="error"><td>Comment</td>			<td>${a.courseComment}</td></tr>
															</table>
													</div>
													<div class="modal-footer">
														 <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
													...
													<div id="${a.courseId}detail" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
														...
														<div class="modal-body">
															<table class="table">
																...
																<tr class="warning"><td>ID</td>                 <td>${a.courseId}</td></tr>
																<tr class="success"><td>Name</td>       		    <td>${a.courseName}</td></tr>
																<tr class="error"><td>Teacher</td>               <td>${a.teachInfo.teachName}</td></tr>
																<tr class="info"><td>Major</td>  			<td>${a.courseMajor}</td></tr>
																<tr class="warning"><td>Remain</td>    			<td>${a.courseRemain}</td></tr>
																<tr class="success"><td>Start</td> 				<td>${a.courseStart}</td></tr>
																<tr class="error"><td>End</td>					<td>${a.courseEnd}</td></tr>
																<tr class="info"><td>Comment</td>			<td>${a.courseComment}</td></tr>
															</table>
													</div>
													<div class="modal-footer">
														 <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
