		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li><a href="#">Course</a> <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li><a href="#">Check all course</a>s <span class="divider"><i class="icon-caret-right"></i></span></li>
					<li class="text-info">Modify course</li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								<h3 class="title">Modify course</h3>
							</div>
							<form id="updateCourseInfo" class="form-horizontal" action="course!updateCourseInfo.action" method="post"/>
								<div class="control-group">
									<label class="control-label">ID</label>
									<div class="controls">
										<input type="text" name="course.courseId" value="${course.courseId}" disabled/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Name</label>
									<div class="controls">
										<input id="name" type="text" name="course.courseName" value="${course.courseName}"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">Teacher</label>
									<div class="controls">
										<input type="text" value="${course.teachInfo.teachName}"/><br/>
									
										<select class="chzn-select-deselect span8" data-placeholder="Select Teacher..." name="course.teachInfo.teachId">
											<c:forEach items="${allTeacher}" var="a">
    											<option value="${a.teachId}">${a.teachName} 开始时间: ${a.teachStart} 结束时间:${a.teachEnd}</option>
    										</c:forEach>
										</select>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="course.courseMajor" value="${course.courseMajor}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input id="remain" type="text" name="course.courseRemain" value="${course.courseRemain}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value='<s:date name="course.courseStart" format="MM-dd-yyyy"/>' name="course.courseStart" class="datePicker" id="datepicker1" placeholder="publish date" /><span class="help-inline"></span>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="course.courseComment" value="${course.courseComment}"/>
									</div>
								</div>
			...
			<script>
			 	var myValidator = new Eui.Validator(document.getElementById('updateCourseInfo'),
				[{
					name: 'name',
					rules: 'required'
				},
