		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Add Teacher Inforomation </li>
				</ul>
					...
					<div class="span8">
						...
						<div class="well widget">
							<div class="widget-header">
								...
								<form action="teacherInfo!addTeacher.action" method="post">
    						
								<div class="control-group">
								
									<label class="control-label" for="inputEmail">Account</label>
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachAccount" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<td><select name="teachInfo.teachLevel.teachLevelId">
   											<c:forEach items="${AllLev}" var="lev">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputPassword" name="teachInfo.teachName"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputPassword">Password</label>
									<div class="controls">
										<input type="password" id="inputPassword" name="teachInfo.teachPsd"/>
									</div>
								</div>
...
<%--                                     
								...
								<div class="control-group">
									...
									<div class="controls">
										male<input id="man" type="checkbox" value="true" name="teachInfo.teachSex"/>
   	                         			female<input id="woman" type="checkbox" value="false" name="teachInfo.teachSex"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachIdentity" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachTel" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachQq"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachAddress"/>
									</div>
								</div>
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachCollage"  />
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachMajor"/>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachClassNumber"/>
									</div>
								</div>
                                 ...
                                 <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachStart" />
									</div>
								</div>
...
<%--                                  <div class="control-group">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachClearForm"/>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="inputEmail" name="teachInfo.teachComment" />
									</div>
								</div>
