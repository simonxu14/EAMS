				...
				<div class="row-fluid">
					<div class="span8">
						...
						<div class="well widget">
							...
							<div class="controls">
									 <form action="teacherInfo!updateTeachUpload.action" method="POST" enctype="multipart/form-data">  
     			 						    choose photo：<input type="file" name="upload" size="10"/><br/>  
       					  					 <input type="submit" value="upload"/>
															...
															<form id="updateTeacherInfo" action="teacherInfo!updateTeaInfo2.action" method="post">
								<input type="hidden" name="teachInfo.teachId" value="${teachInfo.teachId}"/>
    						
								<div class="control-group">
								
									<label class="control-label" for="inputEmail">Account</label>
									<div class="controls">
										<input type="text" id="account" name="teachInfo.teachAccount" value="${teachInfo.teachAccount}" />
									</div>
								</div>
								
								<div class="control-group">
								
									<label class="control-label" for="inputEmail">Teacher Level</label>
									<td><select name="teachInfo.teachLevel.teachLevelId">
   											<c:forEach items="${allLevel}" var="lev">
  												<option value ="${lev.teachLevelId}">${lev.teachLevelName}</option>
  											</c:forEach> 
										</select>
									</td>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="name" name="teachInfo.teachName" value="${teachInfo.teachName}" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="inputPassword">Password</label>
									<div class="controls">
										<input type="password" id="password1" name="teachInfo.teachPsd" value="${teachInfo.teachPsd }" />
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label" for="inputPassword">Photo</label>
    									<td><img src="${teachInfo.teachPhoto}" style="width:100px; height:100px;" /></td>
								...
								<div class="control-group">
									...
									<div class="controls">
										male<input id="sex" type="checkbox" value="true" name="teachInfo.teachSex"/>
   	                         			female<input id="sex" type="checkbox" value="false" name="teachInfo.teachSex"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="idcard" name="teachInfo.teachIdentity" value="${teachInfo.teachIdentity}" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="phone" name="teachInfo.teachTel" value="${teachInfo.teachTel}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="qq" name="teachInfo.teachQq" value="${teachInfo.teachQq}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  name="teachInfo.teachAddress" value="${teachInfo.teachAddress}"/>
									</div>
								</div>
									...
									<div class="controls">
										<input type="text" name="teachInfo.teachCollage" value="${teachInfo.teachCollage}" />
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="teachInfo.teachMajor" value="${teachInfo.teachMajor}"/>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="classnumber" name="teachInfo.teachClassNumber" value="${teachInfo.teachClassNumber}"/>
									</div>
								</div>
                                 ...
                                 <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="teachInfo.teachStart" value="${teachInfo.teachStart}"/>
									</div>
								</div>
                                 ...
                                 <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="teachInfo.teachEnd" value="${teachInfo.teachEnd}"/>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" id="clearform" name="teachInfo.teachClearForm" value="${teachInfo.teachClearForm}"/>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" name="teachInfo.teachComment" value="${teachInfo.teachComment}"/>
									</div>
								</div>
