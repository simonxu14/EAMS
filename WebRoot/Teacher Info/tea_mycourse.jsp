		...
		<div id="left_layout">
			...
			<div id="main_content" class="container-fluid">
				...
				<ul class="breadcrumb breadcrumb-main">
					...
					<li class="text-info">Show my course</li>
				</ul>
						...
						<div class="well widget">
							...
							<div class="widget-content">
								<table class="table">
									...
									<tbody>
									<c:forEach items="${myCourseInfo}" var="course">
										<tr class="success">				
											...
											<td>
											<a id="modal-981935" href="#${course.courseId}" role="button" data-toggle="modal">Detail</a>
													<div id="${course.courseId}" class="modal hide fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-header">
														...
														<div class="modal-body">
															<table class="table">
																...
																<tr class="error"><td>Course ID</td><td>${course.courseId}</td><td></td></tr>
																<tr class="warning"><td>Course Name</td><td>${course.courseName}</td><td></td></tr>
																<tr class="info"><td>Course Major</td><td>${course.courseMajor}</td><td></td></tr>
																<tr class="success"><td>Number of Student</td>
																<td>
																<script type="text/javascript">
																	var a = ${course.courseRemain};
																	document.write(80-a);
																...
																<tr class="error"><td>Course Start Time</td><td>${course.courseStart}</td><td></td><tr>
											
																<tr class="warning"><td>Course End Time</td><td>${course.courseEnd}</td><td></td></tr>
																<tr class="info"><td>Teacher Plan</td><td>${course.teachManagePlan}</td><td><a href="#">Change</a></td></tr>
																<tr class="success"><td>Teacher Case</td><td>${course.teachManageCase}</td><td><a href="#">Change</a></td></tr>
																<tr class="error"><td>Teacher Summary</td><td>${course.teacherSummary}</td><td><a href="#">Change</a></td><tr>
																<tr class="warning"><td>Course Manage Time</td><td>${course.teachManageTime}</td><td><a href="#">Change</a></td></tr>
											...
											<td>
											<a href="teacherInfo!myCourseGrade.action?courseInfo.courseId=${course.courseId}">Teach</a>
											</td>								
										</tr>
										</c:forEach>
									</tbody>
